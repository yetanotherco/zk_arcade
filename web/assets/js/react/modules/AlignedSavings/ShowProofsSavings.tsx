        ...
        <>
            <div className="">
                ...
                <p className="text-xl font-semibold">
                    Base Cost: {calcAlignedSavings(proofs, proof_type, ethPrice, gasCostGwei, proofsPerBatch).baseCost.toPrecision(6)} USD
                </p>
                <p className="text-xl font-semibold">
                    Aligned Cost: {calcAlignedSavings(proofs, proof_type, ethPrice, gasCostGwei, proofsPerBatch).alignedCost.toPrecision(5)} USD
                </p>
                <p className="text-xl font-semibold">
                    Savings: {calcAlignedSavings(proofs, proof_type, ethPrice, gasCostGwei, proofsPerBatch).savings.toPrecision(6)} USD
                </p>
