...
config :zk_arcade, ZkArcadeWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "87mWN4IYPkUWBX2uaEZKdSjyWCw2pw4A/hewER0EoHx5mQXLs3h5qdnTTcMRfly9",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:zk_arcade, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:zk_arcade, ~w(--watch)]}
  ]
...
config :zk_arcade, ZkArcadeWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"lib/zk_arcade_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :zk_arcade, dev_routes: true
...
config :zk_arcade, :leaderboard_address, "0x04C89607413713Ec9775E14b954286519d836FEf"
config :ethereumex,
...
config :zk_arcade, :nft_contract_address, "0x1fA02b2d6A771842690194Cf62D91bdd92BfE28d"
