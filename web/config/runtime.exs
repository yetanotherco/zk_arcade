...
if config_env() == :prod do
  ...
  config :zk_arcade, :second_nft_contract_address, System.get_env("ZK_ARCADE_SECOND_NFT_CONTRACT_ADDRESS")
  ...
  config :zk_arcade, :explorer_url, System.get_env("EXPLORER_URL")
