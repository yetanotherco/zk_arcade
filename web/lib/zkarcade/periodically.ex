defmodule ZkArcade.Periodically do
  require Logger
  ...
  #   PubSub.broadcast(ZkArcade.PubSub, "update_restakings", %{})
  ...
  #   remaining_time = ZkArcadeWeb.Helpers.get_next_scheduled_batch_remaining_time()

  #   PubSub.broadcast(ZkArcade.PubSub, "update_views", %{
  #     next_scheduled_batch_remaining_time_percentage:
  #       ZkArcadeWeb.Helpers.get_next_scheduled_batch_remaining_time_percentage(remaining_time),
  ...
  #   PubSub.broadcast(ZkArcade.PubSub, "update_views", :block_age)
